...
class Invoice
{
     ...
     * @Assert\Type("\DateTimeInterface", message="le format de date doit être YY-MM-DD")
     */
    private $sentAt;
    ...
    /**
     * @ORM\Column(type="integer")
     * @Groups({"invoices_read","customers_read", "invoices_subresource", "invoices_subresource"})
     * @Assert\NotBlank(message="le chrono est obligatoire")
     * @Assert\Type(type="integer", message="le chrono doit être un chiffre")
     */
    private $chrono;

    /**
     * fonction qui permet de récupérer l'utilisateur a qui appartient la facture
